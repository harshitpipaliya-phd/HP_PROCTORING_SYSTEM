...
def insert_behavior_log(behavior_result: dict):
    ...
    try:
        ...
        data = {
            ...
            "prohibited_objects": json.dumps(
                objects.get("prohibited_objects", [])
            ),
...
def fetch_sessions(
    ...
    try:
        ...
        query = (
            _supabase.table("proctoring_sessions")
            .select("*")
            .order("created_at", desc=True)
            .limit(limit)
        )
